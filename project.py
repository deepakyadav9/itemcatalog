...
def gconnect():
    ...
    login_session['gplus_id'] = result['user_id']
    ...
    output += login_session['picture']
    output += """ style = "width: 300px; height: 300px;border-radius: 150px;
              -moz-border-radius-webkit-border-radius: 150px;-moz-border-radius: 150px;">
              """
...
def newMenuItem(restaurant_id):
    ...
    if restaurant.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You are not authorized 
                ...
                Please create your own restaurant in order to add menu item.');}
                </script><body onload='myFunction()'>
               """
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if restaurant.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You are not authorized 
                to edit menu items of this restaurant. 
                Please create your own restaurant in order to do so.');}
                </script><body onload='myFunction()'>
                """
...
def deleteMenuItem(restaurant_id, menu_id):
    ...
    if restaurant.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You are not authorized 
                to delete menu items of this restaurant. 
                Please create your own restaurant in order to do so.');}
                </script><body onload='myFunction()'>
                """
    if request.method == 'POST':
